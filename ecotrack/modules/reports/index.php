...
$stmt = $pdo->prepare("SELECT * FROM trash_reports WHERE reporter_id = ? ORDER BY created_at DESC");
$stmt->execute([$userId]);
...
<section class="py-5">
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4>Your Reports</h4>
            <a href="add.php" class="custom-btn"><i class="bi-plus-lg me-2"></i>New Report</a>
        </div>
        ...
        <div class="text-center py-5">
            ...
            <a href="add.php" class="custom-btn">Submit Your First Report</a>
        </div>
        <?php endif; ?>
    </div>
</section>
