...
$pointsThisWeek = $pointsManager->getPointsThisWeek($userId);
$pointsThisMonth = $pointsManager->getPointsThisMonth($userId);
$pointsHistory = $pointsManager->getPointsHistory($userId, 10);
$userAchievements = $pointsManager->getUserAchievements($userId);

$pageTitle = 'Eco-Points Dashboard';
    ...
    <div class="container">
            ...
            <div class="col-lg-4 mb-4">
                <div class="module-card h-100">
                    ...
                    <div class="module-card-body">
                        ...
                        <div class="mt-3">
                            <a href="achievements.php" class="custom-btn w-100">View All Badges</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="module-card h-100">
                    ...
                    <div class="module-card-body">
                        ...
                        <div class="text-center py-4">
                            ...
                            <a href="<?php echo ROOT_PATH; ?>/modules/reports/add.php" class="custom-btn">Report Trash</a>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                        ...
                        <div class="badges-grid">
                            ...
                            <div class="badge-item earned">
                                ...
                                <div class="badge-info">
                                    ...
                                    <div class="badge-date">Earned <?php echo formatDate($achievement['earned_at']); ?></div>
                                </div>
                            </div>
                            <?php endforeach; ?>
                        </div>
        ...
        <div class="row mt-4">
            <div class="col-12 text-center">
                <a href="leaderboard.php" class="custom-btn custom-btn-lg">
