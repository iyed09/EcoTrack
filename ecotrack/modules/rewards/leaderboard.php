...
if (isLoggedIn()) {
    ...
    $userRank = $pointsManager->getUserRank($userId);
    $userPoints = $pointsManager->getUserPoints($userId);
}
    ...
    <div class="container">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="alert alert-success">
                    <i class="bi-star me-2"></i><strong>Join the competition!</strong> <a href="<?php echo ROOT_PATH; ?>/modules/auth/register.php">Sign up now</a> to start earning eco-points and climb the leaderboard!
                </div>
            </div>
        </div>
        <?php endif; ?>
                ...
                <div class="top-3-podium">
                    <div class="podium-item second">
                        <div class="podium-avatar">
                            ...
                            <img src="<?php echo ROOT_PATH; ?>/uploads/avatars/<?php echo $leaderboard[1]['avatar']; ?>" alt="">
                            <?php else: ?>
                    ...
                    <div class="podium-item first">
                        ...
                        <div class="podium-avatar">
                            ...
                            <img src="<?php echo ROOT_PATH; ?>/uploads/avatars/<?php echo $leaderboard[0]['avatar']; ?>" alt="">
                            <?php else: ?>
                            <i class="bi-person-circle"></i>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="podium-item third">
                        <div class="podium-avatar">
                            ...
                            <img src="<?php echo ROOT_PATH; ?>/uploads/avatars/<?php echo $leaderboard[2]['avatar']; ?>" alt="">
                            <?php else: ?>
                            <i class="bi-person-circle"></i>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="module-card-body">
                        <table class="data-table leaderboard-table">
                            ...
                            <tbody>
                                ...
                                <tr class="<?php echo $user['id'] == $userId ? 'current-user' : ''; ?>">
                                    <td>
                                    ...
                                    <td>
                                        <div class="user-cell">
                                            <div class="user-avatar-small">
                                                <?php if ($user['avatar']): ?>
                                                <img src="<?php echo ROOT_PATH; ?>/uploads/avatars/<?php echo $user['avatar']; ?>" alt="">
                                                <?php else: ?>
                                                <i class="bi-person-circle"></i>
                                                <?php endif; ?>
                                            </div>
        ...
        <div class="row mt-4">
            <div class="col-12 text-center">
                ...
                <a href="achievements.php" class="custom-btn">
