...
<section class="py-5">
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="<?php echo URL_ROOT; ?>/energy/add" class="custom-btn"><i class="bi-plus-lg me-2"></i>Add Entry</a>
        </div>
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo URL_ROOT; ?>/energy/edit/<?php echo $entry['id']; ?>" class="btn btn-sm btn-outline-primary"><i class="bi-pencil"></i></a>
                                    <a href="<?php echo URL_ROOT; ?>/energy/delete/<?php echo $entry['id']; ?>" class="btn btn-sm btn-outline-danger delete-btn"><i class="bi-trash"></i></a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
        ...
        <div class="text-center py-5">
            ...
            <a href="<?php echo URL_ROOT; ?>/energy/add" class="custom-btn">Add Your First Entry</a>
        </div>
        <?php endif; ?>
    </div>
</section>
